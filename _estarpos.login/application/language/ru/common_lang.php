...
$lang["common_welcome_message"] = "Добро пожаловать в STAR Point Of Sale, нажмите модуля ниже, чтобы начать!";
$lang["common_you_are_using_ospos"] = "Вы использоваете STAR Point Of Sale Версия";
